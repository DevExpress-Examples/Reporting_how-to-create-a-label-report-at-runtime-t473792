...
Namespace dxWinFormsSample
	Public Class CustomLabelReportBuilder
		Public Sub New()
		End Sub
		Public Function GenerateLabelReport(ByVal width As Single, ByVal height As Single, ByVal vPitch As Single, ByVal hPitch As Single, ByVal measurementUnit As DevExpress.Drawing.DXGraphicsUnit, ByVal bottomMargin As Single, ByVal topMargin As Single, ByVal leftMargin As Single, ByVal rightMargin As Single, ByVal paperKindID As Integer) As XtraReport
		...
		Private Function BuildLabelReport(ByVal model As CustomLabelReportModel) As XtraReport
			...
			Dim labelDpi As Single = GraphicsDpi.UnitToDpi(CType(model.MeasurementUnit, System.Drawing.GraphicsUnit))
		...
		Private Shared Function ConvertToPaperKindItem(ByVal paperKindData As PaperKindData) As PaperKindItem
			Dim dpi As Single = DevExpress.XtraPrinting.GraphicsDpi.UnitToDpi(CType(paperKindData.Unit, System.Drawing.GraphicsUnit))
			Dim paperKind = CType(paperKindData.EnumId, DXPaperKind)
			Dim size As SizeF = If(paperKind = System.Drawing.Printing.PaperKind.Custom, New SizeF(paperKindData.Width, paperKindData.Height), DXPageSizeInfo.GetPageSizeF(paperKind, dpi, DXPageSizeInfo.DefaultSize))
